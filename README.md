# Dental Disease Detection using ResNet

## Problem Statement
To develop a ResNet-based automated dental disease detection system to improve diagnostic accuracy and reduce examination time.
...
- Designed preliminary preprocessing pipeline
...
- CNN fundamentals and architecture design
- Residual Networks (ResNet) for medical imaging tasks
...
Phase 1: Dataset Collection & Research Study – Completed  
Phase 2: Dataset Expansion & Preprocessing – In Progress  
Phase 3: Model Implementation – Next Phase
